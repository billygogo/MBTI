...
export const AliceDialog: Dialog[] = [
    ...
    {//3
        ...
        buttons: [
            { label: 'B선택', 
            goToDialog: 'q2',
            triggeredActions:  () => {saveData('q1','I','B','q2')}   
            },
            { label: 'A선택', 
            goToDialog: 'q2',
            triggeredActions:  () => {saveData('q1','E','A','q2')}   
             }
        ],
        /*
        image: {
    ...
    {//4
        ...
        buttons: [
            { label: 'B선택',
             goToDialog: 'q3',
             triggeredActions:  () => {saveData('q2','S','B','q3')} 
            },
            { label: 'A선택',
             goToDialog: 'q3',
             triggeredActions:  () => {saveData('q2','N','A','q3')} 
            }
        ]
    ...
    },
    {
        ...
        buttons: [
            { label: 'B선택',
             goToDialog: 'q4',
             triggeredActions:  () => {saveData('q3','T','B','q4')} 
            },
            { label: 'A선택',
             goToDialog: 'q4',
             triggeredActions:  () => {saveData('q3','F','A','q4')} 
            }
        ]
    ...
    },
    {
        ...
        buttons: [
            { label: 'B선택',
             goToDialog: 'q5',
             triggeredActions:  () => {saveData('q4','I','B','q5')} 
            },
            { label: 'A선택',
             goToDialog: 'q5',
             triggeredActions:  () => {saveData('q4','E','A','q5')} 
            }
        ]
    },
    {
        ...
        buttons: [
            { label: 'B선택',
             goToDialog: 'q6',
             triggeredActions:  () => {saveData('q5','S','B','q6')} 
            },
            { label: 'A선택',
             goToDialog: 'q6',
             triggeredActions:  () => {saveData('q5','N','A','q6')} 
            }
        ]
    },
    {
        ...
        buttons: [
            { label: 'B선택', 
             goToDialog: 'q7',
             triggeredActions:  () => {saveData('q6','T','B','q7')} 
            },
            { label: 'A선택',
             goToDialog: 'q7',
             triggeredActions:  () => {saveData('q6','F','A','q7')} 
            }
        ]
    },
    {
        ...
        buttons: [
            { label: 'choose B', 
             goToDialog: 'q8',
             triggeredActions:  () => {saveData('q7','J','B','q8')} 
            },
            { label: 'choose A',
             goToDialog: 'q8',
             triggeredActions:  () => {saveData('q7','P','A','q8')} 
            }
        ]
    },
    {
        ...
        buttons: [
            { label: 'B선택', 
             goToDialog: 'q9',
             triggeredActions:  () => {saveData('q8','J','B','q9')} 
            },
            { label: 'A선택',
             goToDialog: 'q9',
             triggeredActions:  () => {saveData('q8','P','A','q9')} 
            }
        ]
    },
    {
        ...
        buttons: [
            { label: 'B선택', 
             goToDialog: 'q10',
             triggeredActions:  () => {saveData('q9','I','B','q10')} 
            },
            { label: 'A선택',
             goToDialog: 'q10',
             triggeredActions:  () => {saveData('q9','E','A','q10')} 
            }
        ]
    },
    {
        ...
        buttons: [
            { label: 'B선택', 
             goToDialog: 'q11',
             triggeredActions:  () => {saveData('q10','S','B','q11')} 
            },
            { label: 'A선택',
             goToDialog: 'q11',
             triggeredActions:  () => {saveData('q10','N','A','q11')} 
            }
        ]
    },
    {
        ...
        buttons: [
            { label: 'B선택', 
             goToDialog: 'q12',
             triggeredActions:  () => {saveData('q11','J','B','q12')} 
            },
            { label: 'A선택',
             goToDialog: 'q12',
             triggeredActions:  () => {saveData('q11','P','A','q12')} 
            }
        ]
    },
    {
        ...
        buttons: [
            { label: 'B선택', 
             goToDialog: 'q13',
             triggeredActions:  () => {saveData('q12','T','B','q13')} 
            },
            { label: 'A선택',
             goToDialog: 'q13',
             triggeredActions:  () => {saveData('q12','F','A','q13')} 
            }
        ]
    },
    {
